Volunteerings = new orion.collection('volunteering', {
...
Volunteerings.allow({
    update: function (userId, volunteering) {
        return ownsDocument(userId, volunteering);
    },
    remove: function (userId, volunteering) {
        return ownsDocument(userId, volunteering);
    },
});
